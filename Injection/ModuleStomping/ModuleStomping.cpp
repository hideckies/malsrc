...
BOOL ModuleStomping() {
	DWORD dwPid = 13432; // Replace it with a target PID to be injected.
	...
	// *In my experience, the "EXITFUNC=thread" option is required to work correctly.
	...
	WaitForSingleObject(hThread, 1000); // 1000
