# Title: Shellcode Encoder
# Resources:
#   - https://www.ired.team/offensive-security/code-injection-process-injection/writing-custom-shellcode-encoders-and-decoders

# The original shellcode was generated with `msfvenom -p windows/x64/exec CMD=calc.exe -f py -v shellcode`
shellcode =  b""
...
def main():
    ...
    for i in range(len(encoded_shellcode)):
        if i % 12 == 0 and i != 0:
            print("\"\n\t\"", end="")
        print(f"\\x{encoded_shellcode[i]:02x}", end="")
    print("\"\n;")
